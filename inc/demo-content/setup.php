...
add_filter( 'pt-ocdi/import_files', 'sinan_set_import_files' );
...
add_action( 'pt-ocdi/before_content_import', 'sinan_before_content_import' );

/**
 * Define actions that happen after import
 */
function sinan_set_after_import_mods() {
...
add_action( 'pt-ocdi/after_import', 'sinan_set_after_import_mods' );